import { FileText, Paperclip, Pencil, Plus, Sparkles, XCircle } from "lucide-react";
    ...
    <div className="flex flex-col gap-5">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h2 className="text-xl font-bold text-app-foreground">{m.nome}</h2>
              <Badge tone="muted">{m.uf}</Badge>
      ...
      <Panel>
        ...
        <div className="flex flex-col gap-4 p-3 sm:p-5">
          {bs.length === 0 ? (
            <Empty title="Nenhuma base cadastrada" description="Crie a primeira unidade operacional deste município." />
          ) : (
            bs.map((b) => {
